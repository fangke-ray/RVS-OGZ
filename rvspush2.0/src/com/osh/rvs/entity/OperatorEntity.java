...
public class OperatorEntity implements Serializable {
	...
	public Integer getFix_response() {
		return fix_response;
	}

	public void setFix_response(Integer fix_response) {
		this.fix_response = fix_response;
	}
	...
	public List<OperatorEntity> getBelongs() {
		return belongs;
	}
