...
<div id="workarea" class="dwidth-half" style="float:left;margin-left:14px;margin-bottom:16px;font-weight: bolder;">
	<div id="now_nogood" class="leader_grid">
		...
		<table class="condform" style="margin-left : 16px;margin-bottom : 0;width: 450px; height: 30px;border: 1px solid #808080;">
			<tr>
				<th class="ui-state-default" style="width:108px;">修理单号</th>
				<th class="ui-state-default">型号</th>
				<th class="ui-state-default" style="width:60px;">机身号</th>
			</tr>
		</table>
		<table class="condform" style="margin-left : 16px;margin-top : -2px;width: 450px; height: 90px;border: 1px solid #808080;color:red;">
			<tr>
	...
	<div id="now_expedited" class="leader_grid">
		...
		<table class="condform" style="margin-left : 16px;margin-top : -2px;width: 450px; height: 90px;border: 1px solid #808080;color:blue;">
			<tr>
				<td class="td-content" style="width:108px;"><label></label></td>
				<td class="td-content"><label></label></td>
				<td class="td-content" style="width:60px;"><label></label></td>
	...
	<div id="today_plan_outline" class="leader_grid">
		<div class="ui-widget-header ui-corner-top ui-helper-clearfix dwidth-half" style="width : 450px;margin-left : 16px;margin-top : 8px;">
			<span class="areatitle" style="font-size:12px;">同意4天后的维修对象</span>
		...
		<table class="condform" style="margin-left : 16px;margin-top : -2px;width: 450px; height: 90px;border: 1px solid #808080;color: #2A600B;">
			<tr>
				<td class="td-content"><label></label></td>
				<td class="td-content"><label></label></td>
				<td class="td-content"><label></label></td>
	...
	<div id="other_line_closer" class="leader_grid">
		<div class="ui-widget-header ui-corner-top ui-helper-clearfix dwidth-halfr" style="width : 450px;margin-left : 16px;margin-top : 8px;">
			<span class="areatitle" style="font-size:12px;">非S1级操作部完成一览</span>
			<span class="areacount" style="color:#800080;">总数0台</span>
		</div>
		<table class="condform" style="margin-left : 16px;margin-bottom : 0;width: 450px; height: 30px;border: 1px solid #808080;">
			<tr>
				<th class="ui-state-default" style="width:108px;">修理单号</th>
		...
		<table class="condform" style="margin-left : 16px;margin-top : -2px;width: 450px; height: 90px;border: 1px solid #808080;color:#800080;">
			<tr>
				<td class="td-content" style="width:108px;"><label></label></td>
				<td class="td-content"><label></label></td>
				<td class="td-content" style="width:60px;"><label></label></td>
...
<div id="storagearea" style="float:left;margin-left:16px;margin-bottom:16px;position:relative;overflow:hidden;height:600px;">
	...
	<div class="storagepiece">
		<div class="ui-widget-header ui-corner-top ui-helper-clearfix dwidth-half" style="width : 450px;margin-left : 16px;">
			<span class="areatitle" style="font-size:12px;">分解工程进行状况一览</span>
		</div>
		<table class="condform" style="margin-left : 16px;margin-bottom : 0;width: 450px; height: 30px;border: 1px solid #808080;">
			<tr>
				<th class="ui-state-default" style="width:128px;">修理单号</th>
				<th class="ui-state-default">型号</th>
				<th class="ui-state-default" style="width:108px;">分解进行状态</th>
			</tr>
		</table>
		<table class="condform leader_grid" style="margin-left : 16px;margin-top : -2px;width: 450px; height: 548px;border: 1px solid #808080;color:#0080C0;font-weight:bold;">
			<tr>
