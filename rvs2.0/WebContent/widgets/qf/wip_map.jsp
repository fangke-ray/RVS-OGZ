...
font-size:15px;
	...
	<div class="ui-widget-content" style="padding-left:.6em;">
...
<tr>
					<th class="ui-state-default" style="width: 14px;">Ｉ</th>
<td wipid="0-I1">1</td>
<td wipid="0-I2">2</td>
<td wipid="0-I3">3</td>
<td wipid="0-I4">4</td>
...
<td wipid="12-F5">5</td>
	...
	<div class="shelf_model" for="peripharial">
		<div class="cage">
			<div class="ui-widget-header" style="width: 120px; text-align: center;">货架13(周边)</div>
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					<th class="ui-state-default" style="width: 14px;">Ａ</th>
<td wipid="13-A1">1</td>
...
<td wipid="13-F5">5</td>
		...
		<div class="cage">
			<div class="ui-widget-header" style="width: 120px; text-align: center;">货架14(周边)</div>
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					<th class="ui-state-default" style="width: 14px;">Ａ</th>
<td wipid="14-A1">1</td>
...
<td wipid="14-F5">5</td>
		...
		<div class="cage">
			<div class="ui-widget-header" style="width: 120px; text-align: center;">货架15(周边)</div>
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					<th class="ui-state-default" style="width: 14px;">Ａ</th>
<td wipid="15-A1">1</td>
...
<td wipid="15-F5">5</td>
		...
		<div class="cage">
			<div class="ui-widget-header" style="width: 120px; text-align: center;">货架16(周边)</div>
			<table class="condform wip-table" style="width: 120px;">
				<tr>
					<th class="ui-state-default" style="width: 14px;">Ａ</th>
<td wipid="16-A1">1</td>
