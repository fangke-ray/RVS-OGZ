...
<div id="searcharea" class="dwidth-middleright" <% if (!isLeader) { %> style="display: none;" <%} %>>
	...
	<div class="ui-widget-content">
		<form id="searchform" method="POST">
			<table class="condform">
				...
				<tr>
					<td class="ui-state-default td-title">担当工程</td>
					<td class="td-content">
					<select id="search_line_id" class="ui-widget-content">${lOptions}</select></td>
					<td class="ui-state-default td-title">包含失效担当人</td>
					<td class="td-content" id="deleted_set">
...
<% 
	...
	if ("00000000009".equals(role_id) || "00000000005".equals(role_id) || "00000000012".equals(role_id) || "00000000004".equals(role_id)) { 
%>			<div style="height:44px">
				<input type="button" class="ui-button-primary ui-button ui-widget ui-state-default ui-corner-all" id="reportbutton" value="导出上月工时报表" role="button" aria-disabled="false" style="float:right;right:2px">
			</div>
<% 
	}
%>		</form>
