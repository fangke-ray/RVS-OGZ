				...
				complete : function(xhjobj) {
					...
					try {
						...
						if (resInfo.alarm) {
							...
							$("#nogood_process_code").text(resInfo.alarm.position_name);
...
<% if("0".equals(level)) { %>
			...
			<td id="nogoodbtns" class="td-content">
				...
				<input type="button" id="nogoodoperatebtn" class="ui-button" value="警报处理" style="display:none;"></input>
...
<% } else if("1".equals(level)) { %>
			...
			<td id="nogoodbtns" class="td-content">
				...
				<input type="button" id="nogoodoperatebtn" class="ui-button" value="警报处理" style="display:none;"></input>
				<input type="button" id="nogoodcommentbtn" class="ui-button" value="保留警报" style="display:none;"></input>
				<input type="button" id="nogoodwaitbtn" class="ui-button" value="报告技术员"></input>
			</td>
<% } else if("2".equals(level)) { %>
			<td class="ui-state-default td-title">处理方式<input type="hidden" id="break_message_level" value="2"></td>
			<td id="nogoodbtns" class="td-content">
				<input type="hidden" id="nogood_id"></input>
				<input type="button" id="nogoodcommentbtn" class="ui-button" value="信息确认" style="display:block;"></input>
			</td>
<% } %>
<% } %>
			</tr>
