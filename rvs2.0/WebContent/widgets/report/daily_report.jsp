		...
		<table class="condform" style="width:100%">
			...
			<tbody>
				...
				<tr for="service_repair_back">
					...
					<td class="ui-state-default td-subtitle">≦0.05%</td>
					<td class="td-content" weekday_index="1"></td>
					<td class="td-content" weekday_index="2"></td>
					<td class="td-content" weekday_index="3"></td>
					<td class="td-content" weekday_index="4"></td>
				...
				<tr for="final_inspect_pass">
					...
					<td class="ui-state-default td-subtitle">≧99.8%</td>
					<td class="td-content" weekday_index="1"></td>
					<td class="td-content" weekday_index="2"></td>
					<td class="td-content" weekday_index="3"></td>
					<td class="td-content" weekday_index="4"></td>
				...
				<tr for="intime_complete_slt_rate">
					<td class="ui-state-default td-title">大修理6天内纳期遵守比率</td>
				...
				<tr for="intime_complete_medium_rate">
					<td class="ui-state-default td-title">中修理2天内纳期遵守比率</td>
				...
				<tr for="intime_complete_light_rate">
					<td class="ui-state-default td-title">小修理2天内纳期遵守比率</td>
					<td class="ui-state-default td-subtitle">≧90%</td>
					<td class="td-content" weekday_index="1"></td>
					<td class="td-content" weekday_index="2"></td>
					<td class="td-content" weekday_index="3"></td>
				...
				<tr for="total_plan_processed">
					...
					<td class="ui-state-default td-subtitle">≧100%</td>
					<td class="td-content" weekday_index="1"></td>
					<td class="td-content" weekday_index="2"></td>
					<td class="td-content" weekday_index="3"></td>
					<td class="td-content" weekday_index="4"></td>
				...
				<tr for="service_repair_analysis_lt24_rate">
					<td class="ui-state-default td-title">返品分析LT达成率(24小时)</td>
					<td class="ui-state-default td-subtitle">≧93%</td>
					<td class="td-content" weekday_index="1"></td>
					<td class="td-content" weekday_index="2"></td>
					<td class="td-content" weekday_index="3"></td>
					<td class="td-content" weekday_index="4"></td>
				...
				<tr for="service_repair_analysis_lt48_rate">
					<td class="ui-state-default td-title">返品分析LT达成率(48小时)</td>
					<td class="ui-state-default td-subtitle">≧98%</td>
					<td class="td-content" weekday_index="1"></td>
					<td class="td-content" weekday_index="2"></td>
					<td class="td-content" weekday_index="3"></td>
					<td class="td-content" weekday_index="4"></td>
...
// $("#for_complete").val(resInfo.comment || "");
					...
					$("tr[for=half_period_complete] td:eq(0)").text(resInfo.period + "出货目标");
					$("tr[for=half_period_complete] td:eq(1)").text(resInfo.shippingPlanOfHp || "-");
					...
					if (resInfo.dkdList) {
						...
						for (var ii=0; ii<lLength; ii++) {
							...
							$("tr[for=intime_complete_slt_rate] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + (dkd.intime_complete_slt_rate||"") + "' /> %");
							$("tr[for=intime_complete_medium_rate] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + (dkd.intime_complete_medium_rate||"") + "' /> %");
							$("tr[for=intime_complete_light_rate] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + (dkd.intime_complete_light_rate||"") + "' /> %");
							$("tr[for=total_plan_processed] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + (dkd.total_plan_processed_rate||"") + "' /> %");

							$("tr[for=service_repair_analysis_lt24_rate] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + (dkd.service_repair_analysis_lt24_rate||"") + "' /> %");
							$("tr[for=service_repair_analysis_lt48_rate] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + (dkd.service_repair_analysis_lt48_rate||"") + "' /> %");
							$("tr[for=ns_regenerate] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + (dkd.ns_regenerate_rate||"") + "' /> %");

							var inline_passthrough = "";
							if(dkd.inline_passthrough != null) {
								inline_passthrough = dkd.inline_passthrough;
							}
							$("tr[for=inline_passthrough] td[weekday_index=" + (ii+1) + "]").html("<input type='number' value='" + inline_passthrough + "' /> %");
