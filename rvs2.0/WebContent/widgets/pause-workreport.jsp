			...
			<tbody>
				...
				<td class="td-content" style="width:315px;">
					<select name="pause_reason" id="pause_reason" class="ui-widget-content">
						<%=CodeListUtils.getSelectOptions("pause_reason", null, "", false) %>
					</select>
				</td>
				</tr>
				<tr>
				<td class="ui-state-default td-title">备注</td>
				<td class="td-content"><textarea class="ui-widget-content" id="edit_comments" style="width:300px;height:150px;"></textarea></td>
				</tr>
			</tbody>
		</table>
