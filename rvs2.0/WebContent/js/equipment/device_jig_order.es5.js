...
function quotationTrackList(listdata) {
	if ($("#gbox_quotationlist").length > 0) {
		...
		$("#quotationlist").jqGrid({
			...
			colModel: [{ name: 'quotation_no', index: 'quotation_no', width: 100 }, { name: 'acquire_date', index: 'acquire_date', width: 70, align: 'center', sorttype: 'date', formatter: 'date', formatoptions: { srcformat: 'Y/m/d', newformat: 'y-m-d' } }, { name: 'entrust_no', index: 'entrust_no', width: 80 }, { name: 'entrust_send_date', index: 'entrust_send_date', width: 70, align: 'center', sorttype: 'date', formatter: 'date', formatoptions: { srcformat: 'Y/m/d', newformat: 'y-m-d' } }, { name: 'delivery_osh_date', index: 'delivery_osh_date', width: 70, align: 'center', sorttype: 'date', formatter: 'date', formatoptions: { srcformat: 'Y/m/d', newformat: 'y-m-d' } }, { name: 'scheduled_date', index: 'scheduled_date', width: 70, align: 'center', sorttype: 'date', formatter: 'date', formatoptions: { srcformat: 'Y/m/d', newformat: 'y-m-d' } }, { name: 'comment_flg', index: 'comment_flg', width: 40, align: 'center', formatter: function formatter(value, option, rData) {
					if (rData.comment) {
						return "有";
					}
					return "无";
