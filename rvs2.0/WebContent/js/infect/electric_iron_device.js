...
$(function(){
	...
	/*管理编号*/
	setReferChooser($("#hidden_search_devices_manage_id"),$("#manage_code_referchooser"));
	setReferChooser($("#hidden_add_devices_manage_id"),$("#manage_code_referchooser"));
	setReferChooser($("#hidden_edit_devices_manage_id"),$("#manage_code_referchooser"));
	/*设备品名*/
	setReferChooser($("#hidden_search_devices_type_id"),$("#device_name_referchooser"));
	setReferChooser($("#hidden_add_devices_type_id"),$("#device_name_referchooser"));
	setReferChooser($("#hidden_edit_devices_type_id"),$("#device_name_referchooser"));
	/*所在工位*/
	setReferChooser($("#hidden_search_position_id"),$("#position_code_referchooser"));
	setReferChooser($("#hidden_add_position_id"),$("#position_code_referchooser"));
	setReferChooser($("#hidden_edit_position_id"),$("#position_code_referchooser"));
...
var showDelete = function(rid){
	...
	warningConfirm("删除不能恢复。确认要删除[管理编号:"+encodeText(rowData.manage_code)+";温度点检序号:"+encodeText(rowData.seq)+"]的记录吗？",
		function() {
			// Ajax提交
			$.ajax({
				beforeSend : ajaxRequestType,
