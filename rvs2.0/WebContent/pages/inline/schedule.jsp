...
<script type="text/javascript" src="js/inline/schedule.js?version=188"></script>
			...
			<div id="functionarea" class="dwidth-full" style="margin: auto;">
				<div class="ui-widget-header ui-corner-all ui-helper-clearfix areabase">
					<div id="executes" style="margin-left: 4px; margin-top: 4px;">
						...
						<input type="button" id="updatescheduledbutton" class="ui-button" value="修改预定纳期日期"/>
			...
			<div id="planned_listarea" class="dwidth-full">
				...
				<!-- table id="tuli_2" style="width: 1250px;margin: 0;background-color:white;
					...
					<tr>
						...
						<td width="20%">A : 8:00 ~ 10:00</td>
						<td width="20%">B : 10:00 ~ 12:00</td>
						<td width="20%">C : 13:00 ~ 15:00</td>
						<td width="20%">D : 15:00 ~ 17:15 (或加班结束)</td>
					</tr>
				</table -->
...
<div id="update_scheduled_dialog">
</div>
	</div>
