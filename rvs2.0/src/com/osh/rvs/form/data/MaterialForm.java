...
public class MaterialForm extends ActionForm {
	...
	@BeanField(title = "返送地区", name = "bound_out_ocm", type = FieldType.Integer, length = 2)
	private String bound_out_ocm;

	@BeanField(title = "销售大区", name = "area", type = FieldType.Integer, length = 1)
	private String area;

	@BeanField(title="OSH发送日期", name="osh_deliver_date", type = FieldType.Date)
	private String osh_deliver_date;
	private String return_ocm;
	...
	/**
	 * @param doreception_time the doreception_time to set
	 */
	...
	/**
	 * @param processing_position2 the processing_position2 to set
	 */
	...
	public String getOsh_deliver_date() {
		return osh_deliver_date;
	}
	public void setOsh_deliver_date(String osh_deliver_date) {
		this.osh_deliver_date = osh_deliver_date;
	}
	public String getReturn_ocm() {
		return return_ocm;
	}
	public void setReturn_ocm(String return_ocm) {
		this.return_ocm = return_ocm;
	}
