...
public class MaterialPartialForm extends ActionForm {
	...
	@BeanField(title = "零件缺品备注", name = "bo_contents", type = FieldType.String, length = 400)
	...
	@BeanField(title = "缺品发生工位", name = "bo_position", type = FieldType.String, length = 100)
	private String bo_position;
	...
	public String getBo_position() {
		return bo_position;
	}

	public void setBo_position(String bo_position) {
		this.bo_position = bo_position;
	}
	...
	public String getHas_bo_content() {
		return has_bo_content;
	}

	public void setHas_bo_content(String has_bo_content) {
		this.has_bo_content = has_bo_content;
	}
