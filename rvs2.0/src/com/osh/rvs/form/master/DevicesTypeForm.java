...
public class DevicesTypeForm extends UploadForm implements Serializable {
	...
	/* 设备工具品名ID */
	@BeanField(title = "设备工具品名ID", name = "device_type_id", type = FieldType.String, primaryKey = true, length = 11)
	...
	public String getHazardous_cautions() {
		return hazardous_cautions;
	}
