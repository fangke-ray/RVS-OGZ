...
public class LineLeaderForm extends ActionForm implements Serializable {
	...
	@BeanField(title = "工位名称", name = "otherline_position_name", type = FieldType.String, length = 15)
	private String otherline_position_name;
	...
	public String getOtherline_position_name() {
		return otherline_position_name;
	}
	public void setOtherline_position_name(String otherline_position_name) {
		this.otherline_position_name = otherline_position_name;
	}
