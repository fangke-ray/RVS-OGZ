...
public class DeviceJigRepairRecordForm extends UploadForm implements Serializable {
	...
	@BeanField(title = "原因分类", name = "cause_type", type = FieldType.Integer, length = 1)
	...
	@BeanField(title = "是否需要备品", name = "spare_supplement", type = FieldType.String, length = 64)
	private String spare_supplement;
	@BeanField(title = "是否需要追加点检项目", name = "additional_infect_feature", type = FieldType.String, length = 32)
	private String additional_infect_feature;
	@BeanField(title = "此次发现其它隐患", name = "latent_trouble", type = FieldType.String, length = 256)
	private String latent_trouble;
	...
	public void setLine_break(String line_break) {
		this.line_break = line_break;
	}
	public String getSpare_supplement() {
		return spare_supplement;
	}
	public void setSpare_supplement(String spare_supplement) {
		this.spare_supplement = spare_supplement;
	}
	public String getAdditional_infect_feature() {
		return additional_infect_feature;
	}
	public void setAdditional_infect_feature(String additional_infect_feature) {
		this.additional_infect_feature = additional_infect_feature;
	}
	public String getLatent_trouble() {
		return latent_trouble;
	}
	public void setLatent_trouble(String latent_trouble) {
		this.latent_trouble = latent_trouble;
	}
