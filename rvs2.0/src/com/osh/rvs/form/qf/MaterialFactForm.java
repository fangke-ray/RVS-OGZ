...
public class MaterialFactForm extends ActionForm {
	...
	@BeanField(title = "机种类别", name = "category_kind", type = FieldType.String)
	...
	@BeanField(title = "已排入计划", name = "seq", type = FieldType.Integer)
	...
	public void setNew_model(String esas_no) {
		this.new_model = esas_no;
	}
