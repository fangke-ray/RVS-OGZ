...
public class ServiceRepairManageForm extends ActionForm implements Serializable {
	...
	@BeanField(title = "RC出货指示日", name = "rc_ship_assign_date", type = FieldType.Date)
	...
	@BeanField(title = "质量信息单号", name = "quality_info_no", type = FieldType.String, length = 20)
	...
	@BeanField(title = "QIS3", name = "qis3_info", type = FieldType.String, length = 40)
	private String qis3_info;
	...
	public String getQis3_info() {
		return qis3_info;
	}

	public void setQis3_info(String qis3_info) {
		this.qis3_info = qis3_info;
	}
