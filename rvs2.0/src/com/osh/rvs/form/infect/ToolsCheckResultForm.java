...
public class ToolsCheckResultForm extends ActionForm {
	...
	/* 治具管理 */
	@BeanField(title="治具管理ID",name="jig_manage_id",type=FieldType.String)
	private String tools_manage_id;
	@BeanField(title="管理编号",name="manage_code",type=FieldType.String)
	private String manage_code;
	@BeanField(title="治具NO.",name="jig_no",type=FieldType.String)
	...
	@BeanField(title="计量",name="count_in",type=FieldType.Integer)
