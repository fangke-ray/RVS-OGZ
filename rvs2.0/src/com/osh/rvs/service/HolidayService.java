...
public class HolidayService {
	...
	public void fixScheduledDate(Map<String, Object> callbackResponse,
		...
		for (MaterialEntity me : list) {
			...
			String agreedDateGetTimeKey = agreedDate.getTime() + "_" + level + "_" + scheduledExpedite;

			if (!catchMap.containsKey(agreedDateGetTimeKey)) {
				Date[] timeLimit = RvsUtils.getTimeLimit(agreedDate, level, scheduledExpedite, conn, false);
