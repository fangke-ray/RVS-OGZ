...
public class DefectiveAnalysisSearchEntity implements Serializable{

	private static final long serialVersionUID = -7913620955362179253L;

	private Integer alarm_message_id;
	...
	private String cm_effect_confirmer_date_from;

	private String cm_effect_confirmer_date_to;
	...
	public String getCm_effect_confirmer_date_from() {
		return cm_effect_confirmer_date_from;
	}

	public void setCm_effect_confirmer_date_from(String cm_effect_confirmer_date_from) {
		this.cm_effect_confirmer_date_from = cm_effect_confirmer_date_from;
	}

	public String getCm_effect_confirmer_date_to() {
		return cm_effect_confirmer_date_to;
	}

	public void setCm_effect_confirmer_date_to(String cm_effect_confirmer_date_to) {
		this.cm_effect_confirmer_date_to = cm_effect_confirmer_date_to;
	}

	public Integer getAlarm_message_id() {
		return alarm_message_id;
	}

	public void setAlarm_message_id(Integer alarm_message_id) {
