...
public class ExternalAdjustmentEntity implements Serializable {
	...
	private String devices_manage_id;// 点检管理ID
	...
	public void setJig_manage_id(String tools_manage_id) {
		this.jig_manage_id = tools_manage_id;
	}
