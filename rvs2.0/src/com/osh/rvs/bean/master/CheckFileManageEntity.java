...
public class CheckFileManageEntity implements Serializable {
	...
	public static final Integer FILE_CYCLE_TYPE_MONTH = 7;
	public static final Integer FILE_CYCLE_TYPE_PERIOD = 8;
	...
	public static final Integer CYCLE_TYPE_PERIOD_OF_PERIOD = 4;
	...
	private String device_type_id;// 设备工具品名ID
	...
	public Integer getConfirm_cycle() {
