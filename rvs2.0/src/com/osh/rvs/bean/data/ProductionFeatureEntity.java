...
public class ProductionFeatureEntity implements Serializable  {
	...
	private BigDecimal sum_use_seconds;
	...
	public BigDecimal getSum_use_seconds() {
		return sum_use_seconds;
	}

	public void setSum_use_seconds(BigDecimal sum_use_seconds) {
		this.sum_use_seconds = sum_use_seconds;
	}
