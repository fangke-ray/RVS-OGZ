...
public class MaterialPartialEntity implements Serializable {
	...
	private String bo_position;// 缺品发生工位

	private Date reception_time;// 受理时间
	
	private Date agreed_date;// 同意日
	
	private String omr_notifi_no;//修理单号
	
	private Date inline_time;//投线时间
	
	private Integer has_bo_content;
	...
	public Integer getHas_bo_content() {
		return has_bo_content;
	}

	public void setHas_bo_content(Integer has_bo_content) {
