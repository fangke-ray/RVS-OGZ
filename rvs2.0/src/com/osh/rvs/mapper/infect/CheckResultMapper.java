...
public interface CheckResultMapper {
	 ...
	 * 查找点检治具对象(担当者)
	 */
	public List<JigManageEntity> searchToolCheckPositionsByOperator(
	 ...
	 * 取得上级(治具管理者)的签章
	 */
	public List<CheckResultEntity> getJigUpperStamp(CheckResultEntity cond);

	/**
	 * 上级(治具管理者)确认
	 */
	public int setJigUpperConfirm(CheckResultEntity entity);

	/**
	 * 取得上级(治具管理者)的签章
	 */
	public List<CheckResultEntity> getDeviceUpperStamp(CheckResultEntity cond);

	/**
	 * 上级(治具管理者)确认
	 */
	public int setDeviceUpperConfirm(CheckResultEntity entity);
